...
MSL 5.1 helps identify the field, locate the sovereign source/body, choose a proportionate form, define the passage contract and read back what the recipient is likely to infer. It also carries the explicit formatting contract established by the 5.x postflight: Markdown-native by default, no ornamental fences, object dissolving, proportional tables and clean raw readability.
