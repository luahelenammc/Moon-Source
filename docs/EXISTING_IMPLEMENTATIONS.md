...
| Chat–Work routing | [Chat–Work Routing Protocol V2](../portables/chat-work/CHAT_WORK_ROUTING_PROTOCOL_V2.md) | PUBLIC_ARTIFACT | A routing protocol is published; model, price and usage calibration require freshness checks. |
