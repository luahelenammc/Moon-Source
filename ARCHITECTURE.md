...
For supporting decisions, use the [Responsibility Map](docs/RESPONSIBILITY_MAP.md) and [🧱 Moon Source Language](portables/msl/MOON_SOURCE_LANGUAGE.md).
...
Moon Source Language, or MSL, is the structural grammar used by the Moon Source work. MSL 5.1 makes semantic passage explicit while remaining adaptive and Markdown-native. It helps choose form from field pressure while preserving source authority, continuity, provenance, proportionality and active-state hygiene.
