...
[**Be My Eyes**](portables/be-my-eyes/BE_MY_EYES.md) is the independently readable transportable edition; its current version is `1.0-public`. Its broader public method is governed by [`docs/BE_MY_EYES.md`](docs/BE_MY_EYES.md). The portable can travel alone; the method source remains the canonical public explanation of the responsibility and its relationship to adjacent Moon Source components.
