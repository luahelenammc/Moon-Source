...
| chat-work-routing | [Chat–Work Routing Protocol](../portables/chat-work/README.md) | operational routing protocol | 5.0 | current | [CHAT_WORK_ROUTING_PROTOCOL_V4.md](../portables/chat-work/CHAT_WORK_ROUTING_PROTOCOL_V4.md#first-use) | [ZIP](../downloads/chat-work-routing-protocol-v4.zip) |
...
- https://www.luahelena.com.br/moonsource/downloads/CHAT_WORK_ROUTING_PROTOCOL_V4_MSL_5_0.md
...
change a capability version. The current standalone releases are Connected Sources at 1.1-public, MSL at 5.1, Chat–Work at 5.0, Setup at 3.1, Preflight at 2.1 and Be My Eyes at 1.0-public. Chat–Work 5.0 adds optional explicitly activated ephemeral Sprint Mode, a bounded Decision Sprint exception and Sprint Receipts; MSL's formatting contract is part of the current 5.1 body and release identity.
