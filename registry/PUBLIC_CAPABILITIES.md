...
|---|---|---|---:|---|---|---|
| be-my-eyes | [Be My Eyes](../portables/be-my-eyes/README.md) | contextual scene-reading method | 1.0 | current | [BE_MY_EYES.md](../portables/be-my-eyes/BE_MY_EYES.md#first-use) | [ZIP](../downloads/be-my-eyes-1.0.zip) |
| chat-work-routing | [Chat–Work Routing Protocol](../portables/chat-work/README.md) | operational routing protocol | 4.7 | current | [CHAT_WORK_ROUTING_PROTOCOL_V4.md](../portables/chat-work/CHAT_WORK_ROUTING_PROTOCOL_V4.md#first-use) | [ZIP](../downloads/chat-work-routing-protocol-v4.zip) |
| connected-sources | [Connected Sources](../portables/connected-sources/README.md) | structural crown jewel | 1.1 | current | [CONNECTED_SOURCES.md](../docs/CONNECTED_SOURCES.md#first-use) | [ZIP](../downloads/connected-sources-1.1.zip) |
...
responsibility. It remains independently distributable as version 1.1.
...
- https://www.luahelena.com.br/moonsource/downloads/CHAT_WORK_ROUTING_PROTOCOL_V4_MSL_4_7.md
...
change a capability version. This corrective MSL release remains current alongside Connected Sources at 1.1, MSL at 5.0, Chat–Work at 4.7, Setup at 3.1, Preflight at 2.0 and Be My Eyes at 1.0. MSL's formatting contract is part of the current 5.0 body and release identity.
