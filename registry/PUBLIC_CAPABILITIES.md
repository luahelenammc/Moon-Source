...
| chat-work-routing | [Chat–Work Routing Protocol](../portables/chat-work/README.md) | operational routing protocol | 4.8 | current | [CHAT_WORK_ROUTING_PROTOCOL_V4.md](../portables/chat-work/CHAT_WORK_ROUTING_PROTOCOL_V4.md#first-use) | [ZIP](../downloads/chat-work-routing-protocol-v4.zip) |
...
change a capability version. This corrective MSL release remains current alongside Connected Sources at 1.1-public, MSL at 5.0, Chat–Work at 4.8, Setup at 3.1, Preflight at 2.0 and Be My Eyes at 1.0-public. MSL's formatting contract is part of the current 5.0 body and release identity.
