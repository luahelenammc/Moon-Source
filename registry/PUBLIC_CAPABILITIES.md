...
|---|---|---|---:|---|---|---|
| be-my-eyes | Be My Eyes | contextual scene-reading method | 1.0-public | current | [BE_MY_EYES.md](../portables/be-my-eyes/BE_MY_EYES.md#first-use) | [ZIP](../downloads/be-my-eyes-1.0-public.zip) |
| chat-work-routing | Chat–Work Routing Protocol | operational routing protocol | 4.4-public | current | [CHAT_WORK_ROUTING_PROTOCOL_V4.md](../portables/chat-work/CHAT_WORK_ROUTING_PROTOCOL_V4.md#first-use) | [ZIP](../downloads/chat-work-routing-protocol-v4.zip) |
| connected-sources | Connected Sources | structural crown jewel | 1.1-public | current | [CONNECTED_SOURCES.md](../docs/CONNECTED_SOURCES.md#first-use) | [ZIP](../downloads/connected-sources-1.1-public.zip) |
...
| moon-source-language | Moon Source Language | structural grammar | 4.3 | current | [MSL_4_3.md](../portables/msl/MSL_4_3.md#first-use) | [ZIP](../downloads/moon-source-language-4.3.zip) |
| moon-source-setup | Moon Source Setup | adaptive context router | 3.1 | current | [MOON_SOURCE_SETUP.md](../portables/setup/MOON_SOURCE_SETUP.md#first-use) | [ZIP](../downloads/moon-source-setup-3.1.zip) |
...
| preflight | Preflight | transversal interface method | 2.0 | current | [PREFLIGHT_V2.md](../portables/preflight/PREFLIGHT_V2.md#first-use) | [ZIP](../downloads/preflight-v2.zip) |
...
package and its exact-byte website mirror live.
...
change a capability version. This rebase keeps Connected Sources at
1.1-public, MSL at 4.3, Chat–Work at 4.4-public, Setup at 3.1,
Preflight at 2.0 and Be My Eyes at 1.0-public.
