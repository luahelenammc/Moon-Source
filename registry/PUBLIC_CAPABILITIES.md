...
| chat-work-routing | [Chat–Work Routing Protocol](../portables/chat-work/README.md) | operational routing protocol | 6.0 | current | [CHAT_WORK_ROUTING_PROTOCOL.md](../portables/chat-work/CHAT_WORK_ROUTING_PROTOCOL.md#first-use) | [ZIP](../downloads/chat-work-routing-protocol.zip) |
...
1.2, Connected Sources at 1.1-public, MSL at 5.1, Chat–Work at 6.0,
Setup at 3.1, Preflight at 2.3 and Be My Eyes at 1.0-public. Chat–Work 6.0
promotes Delegation-First orchestration and heterogeneous root/child model topology to stable protocol law while preserving the model-neutral strategy-adapter boundary, Sprint, IDL, Decision Trace and Chat Postflight. The Astra Strategy Adapter is 1.3 and the GPT-6 Sol/Luna Adapter is 1.2; their named-model and subagent calibration remains dated and subordinate. MSL's formatting contract remains part of the current 5.1 body and release identity.
