...
The registry records portable identity and fingerprints. It does not replace [Credits & Attribution Ops](../docs/CREDITS_ATTRIBUTION_OPS.md), which governs the broader intellectual chain of custody, and it does not grant permission to reuse a public artifact.
